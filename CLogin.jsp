...
<nav>
    ...
    <div class="container">
		...
		<form action = "Cloginsuccess.jsp" method ="post">
			<label>SSN ID</label>
			<input type="text" id="cloginid" name="cloginid" placeholder="Enter SSN ID">
			<label>Password</label>
			<input type="password" id="cloginpass" name="cloginpass" placeholder="Enter Password">
			<div class="btn-group">
			<button type="submit" id="cloginsubmit" value="Login" name="cloginsubmit">Login</button>
			</div>
		</form>
</div>
<main>
