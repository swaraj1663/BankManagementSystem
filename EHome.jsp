        ...
        <section class="hero">
            <div class="hero-content">
            	<div class="auth-buttons2">
                 <a href="Caccountcreation.jsp"><button ><span><i>......</i>Create Account<i>......</i></span></button></a>
            <a href="Ctransactionmain.jsp"><button class="transaction" ><span>Make a Transactions</span></button></a>
            </div>
            <div class=auth-buttons3>
            <a href="CDetailsFetch.jsp"><button class="transaction"><span><i>....</i>Customer Details<i>.....</i></span></button></a>
            </div>
            </div>
